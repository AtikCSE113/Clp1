        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                      <img src="panel/assets/images/author/avatar.png" class="img-circle elevation-2" alt="User Image">
                    </div>
                    <div class="info">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                           <li class=""><a href="/dashboard"><i class="ti-dashboard"></i> <span>Dashboard</span></a></li>
  ...
  <div class="row align-items-center">
      ...
      <div class="col-sm-6 clearfix">
          <div class="user-profile pull-right">
              ...
              <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Samiha Shaon <i class="fa fa-angle-down"></i></h4>
